...
import (
	...
	"github.com/SmallYangCong/rpcx/tool/xgen/parser"
)
...
func generate(parsers []*parser.Parser) error {
	...
	fmt.Fprintln(w, `  "github.com/SmallYangCong/rpcx/server"`)
	fmt.Fprintln(w, `  "github.com/SmallYangCong/rpcx/serverplugin"`)
